...
/*static u_char Mine[6] = { 0x34, 0xe6, 0xd7, 0x57, 0x4b, 0x59 };*/
static u_char Mine[6] = { 0x00, 0xe0, 0x4c, 0x68, 0x00, 0x30 };
static char username[] = "S1401073";
static char password[] = "030012";
...
void packet::init_start()
{
	...
	init_eapol((eapol_header*)(pkt + 14), EAP_TYPE::Start, 0);
}
...
void packet::init_indentity(u_char *dst_mac, u_char id)
{
	...
	init_eapol((eapol_header*)(pkt + 14), EAP_TYPE::Packet, htons(len));
}
...
/*	std::cout << calc_md5.toString() << std::endl;*/
	...
	init_eapol((eapol_header*)(pkt + 14), EAP_TYPE::Packet, htons(
...
void packet::init_keepalive(u_char*dst_mac,unsigned int key)
{
	...
	init_eapol((eapol_header*)(pkt + 14), EAP_TYPE::Keepalive, htons(30));
